	...
	async function requestRetentionCleanup(ctx: ExtensionContext) {
		...
		await pi.sendUserMessage(
			[
				...
				`4. Search datadog-google-workspace folder ${driveFolderId} for the exact backupName. Reuse an exact existing file; otherwise create one text/markdown Drive file in that folder with backupContent.`,
